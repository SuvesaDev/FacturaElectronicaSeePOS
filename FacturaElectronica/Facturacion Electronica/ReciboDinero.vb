...
Public Class ReciboDinero
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "FacturaElectronica.ReciboDinero.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Id_Recibo() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedReciboDinero
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReciboDinero = New ReciboDinero()
        rpt.Site = Me.Site
        Return rpt
    End Function

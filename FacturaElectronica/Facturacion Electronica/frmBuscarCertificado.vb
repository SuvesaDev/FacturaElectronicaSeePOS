...
Public Class frmBuscarCertificado
    ...
    Private Sub Certificado_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            ...
            viewCertificados.DataSource = dsCertificados
            viewCertificados.DataMember = "Certificados"
    ...
    Private Sub grdCertificados_CellContentDoubleClick(sender As Object, e As DataGridViewCellEventArgs) Handles viewCertificados.CellContentDoubleClick
        Try
            thumbprint = viewCertificados.Rows(e.RowIndex).Cells(1).Value
            Me.Close()
        Catch ex As Exception
            Throw
        End Try
